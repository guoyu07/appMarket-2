<template>
  <div id="criminalManage">
      ...
      <Col span='21'>
        <div class='right_content'>
          ...
          <div class="query_wrap clearfix">
            <Input v-model="query" size="large" placeholder="罪犯编号" style="width:200px;float:left;margin-right:10px;"></Input>
            <Input v-model="query" size="large" placeholder="姓名" style="width:200px;float:left;margin-right:10px;"></Input>
            <Input v-model="query" size="large" placeholder="罪犯胸牌" style="width:200px;float:left;"></Input>
    ...
    <!-- 编辑模态框 -->
    <Modal v-model="editModal" title="罪犯修改" :mask-closable='false' class="nofoot" >
        <div class="editForm">
    ...
    <!-- 删除模态框 -->
    <Modal v-model="delModal" title='罪犯删除' :mask-closable='false'>
      <p style="font-size:16px">确定删除该罪犯？</p>
    </Modal>
  </div>
</template>
