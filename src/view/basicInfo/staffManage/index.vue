<template>
  <div id="staffManage">
      ...
      <Col span='21'>
        <div class='right_content'>
          ...
          <div class="query_wrap clearfix">
            <Input v-model="query" size="large" placeholder="职工编号" style="width:200px;float:left;margin-right:10px;"></Input>
    ...
    <!-- 编辑模态框 -->
    <Modal v-model="editModal" title="职工修改" :mask-closable='false' class="nofoot" >
        <div class="editForm">
    ...
    <!-- 删除模态框 -->
    <Modal v-model="delModal" title='职工删除' :mask-closable='false'>
      <p style="font-size:16px">确定删除该职工？</p>
    </Modal>
  </div>
</template>
